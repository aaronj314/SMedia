...
CREATE TABLE `ApplicationSettings` (
  ...
  `ValueType` char(10) DEFAULT NULL,
  `Value` varchar(500) NOT NULL DEFAULT '',
  `UnitLabel` varchar(10) DEFAULT NULL,
...
CREATE TABLE `JobPresets` (
  ...
  `EncoderType` varchar(25) DEFAULT NULL,
...
DROP TABLE IF EXISTS `workflowCategories`;
CREATE TABLE `workflowCategories` (
  `workflowCategoryId` char(36) NOT NULL,
  `Name` varchar(50) NOT NULL DEFAULT '',
  `Description` varchar(256) DEFAULT NULL,
  `Created` datetime DEFAULT NULL,
  `Modified` datetime DEFAULT NULL,
  PRIMARY KEY (`workflowCategoryId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `LicenseKeys` (
  `LicenseKeyId` char(1) NOT NULL DEFAULT '',
  `LicenseKey` varchar(60) NOT NULL DEFAULT '',
  `Created` datetime DEFAULT NULL,
